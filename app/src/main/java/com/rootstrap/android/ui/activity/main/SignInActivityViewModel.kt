...
open class SignInActivityViewModel(delegate: ViewModelDelegate?) : BaseViewModel(delegate) {
...
class SignInActivityViewModelFactory(var delegate: ViewModelDelegate?) : ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return SignInActivityViewModel(delegate) as T
    }
}
